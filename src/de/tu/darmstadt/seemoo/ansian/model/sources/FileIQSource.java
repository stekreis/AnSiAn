...
/**
 * <h1>AnSiAn - File Source of IQ samples</h1>
 *
 * Module: FileIQSource.java Description: Simple source of IQ sampling by
...
public class FileIQSource implements IQSourceInterface {
	...
	private int sleepTime = 0; // min. time (in ms) between two getPacket()
								// calls to simulate the sample rate
	...
	public FileIQSource(String filename, int sampleRate, long frequency, int packetSize, boolean repeat,
		...
		this.sleepTime = (int) ((packetSize / 2) / (float) sampleRate * 1000); // note:
																				// half
																				// packet
																				// size
																				// because
	...
	public void setSampleRate(int sampleRate) {
		// Log.e(LOGTAG, "Setting the sample rate is not supported on a file
		// source");
	}
	...
	public void setFrequency(long frequency) {
		// Log.e(LOGTAG, "Setting the frequency is not supported on a file
		// source");
	}
