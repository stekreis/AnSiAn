...
/**
 * <h1>AnSiAn - signed 8-bit IQ Converter</h1>
 *
 * Module: Signed8BitIQConverter.java Description: This class implements methods
 * to convert the raw input data of IQ sources (8 bit signed) to SamplePackets.
...
public class Signed8BitIQConverter extends IQConverter {
	...
	protected void generateLookupTable() {
		/**
		 * The HackRF delivers samples in the following format: The bytes are
		 * interleaved, 8-bit, signed IQ samples (in-phase component first,
